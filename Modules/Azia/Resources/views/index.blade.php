...
@push('page-js')
<script src="{{ asset('tema/js/chart.flot.sampledata.js') }}" type="text/javascript"></script>
<script src="{{ asset('tema/js/dashboard.sampledata.js') }}" type="text/javascript"></script>
@include('azia::scripts.page-script')
@endpush
...
<div class="az-content az-content-dashboard">
    <div class="container">
      <div class="az-content-body">
        @include('azia::dashboard.page-nav')
...
@section('ori')
    ...
    <p>
        This view is loaded from module: {!! config('azia.name') !!}
    </p>
@endsection
